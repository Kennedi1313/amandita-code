...
export default function CardWithImageForSelling({ id, name, description, price, category, stockQuantity, profileImageId, quantity, promo, withController, onClose, toast }) {
    ...
    const { favoritesDetails, addItemToFavorites, removeItem } = useShoppingFavorites();
    ...
    return (
        <Flex width="full" my={2} py={2}>
            ...
            >
                ...
                {/* Product Info */}
                <Box p={4} width="full" display={'flex'} gap={4} flexDirection={'column'} h={'full'} justifyContent={'space-between'}>
                    {/* Quantity Controller */}
                        ...
                        <Flex>
                            {
                                ...
                                <Flex flexDirection={"column"}>
                                    <Text textDecoration={"line-through"} color={"red.600"}>{ formatCurrency(price) }</Text>
                    ...
                    <Stack direction="row" align="center" w={'fit-content'} spacing={0} border="1px solid" borderColor={'gray.300'} rounded={'md'}>
                        {withController ? 
                        <>
                            <Button
                                rounded={0}
                            ...
                            <Button
                                ...
                                color={'gray.600'}
                                backgroundColor={'white'}
                                borderLeft="1px solid" borderColor={'gray.300'}
                                fontSize={26}
