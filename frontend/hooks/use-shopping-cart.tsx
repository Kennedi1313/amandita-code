...
const addItemToCart = (state: Cart = {} as Cart, product: Product|null = null, quantity = 0) => {
...
const removeItem = (state: Cart = {} as Cart, product: Product|null = null, quantity = 0) => {
  if (quantity <= 0 || !product) return state;
...
const cartReducer: Reducer<Cart, Action> = (state: Cart = {} as Cart, action: Action) => {
  switch (action.type) {
    case 'ADD_ITEM':
