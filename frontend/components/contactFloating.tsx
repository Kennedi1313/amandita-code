...
export default function ContactFloating() {
    ...
    return (
        <div>
            <a href={"https://api.whatsapp.com/send?phone=+55" + storeInfo?.whatsapp + "&text=Olá,%20tudo%20bem?%20Gostaria%20de%20algumas%20informações." }
                target='blank' 
            ...
            <a className="z-50 fixed right-3 bottom-32 w-14 h-14 rounded-full 
                ...
                href={"https://www.instagram.com/" + storeInfo?.instagram} target='blank'>
