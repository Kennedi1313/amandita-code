...
export default function PromotionBanner() {
  ...
  return (
    <div
      className="w-full text-center text-sm p-2 font-semibold bg-black-1000 text-white embla z-50 fixed"
      ref={emblaRef}
    >
      <div className="embla__container">
        ...
        <div className="embla__slide">Toda a loja em até 3x sem juros*</div>
      </div>
    </div>
  );
}
