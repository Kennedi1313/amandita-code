...
export default function Item(props: ItemProps) {
    ...
    <div className='relative'>
        <Link href={'/details/' + props.id} className='flex flex-col gap-2 w-full h-[28rem] bg-white'>
        ...
        <Share productName={props.name} productUrl={"https://www."+storeInfo.domain+"/details/" + props.id} />
        ...
        { props.quantity == 0 ?
            <a href={"https://api.whatsapp.com/send?phone=8498594171&text=Olá,%20tudo%20bem?%20Gostaria%20de%20ser%20avisado%20quando%20este%20produto%20chegar%20em%20estoque:%20https://www."+storeInfo.domain+"/details/" + props.id}
                target='blank'
