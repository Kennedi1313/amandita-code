...
export const getProductsNoStore = async () => {
    try {
        const res = await axios.get(`https://api.amanditapratas.com.br/api/v1/products/no-store`);
        return res.data;
    } catch (e) { throw e }
}
...
export const getProductsByIdNoStore = async (id: number, url?: string) => {
    try {
        const res = await axios.get(`https://api.amanditapratas.com.br/api/v1/products/${id}`);
        return res.data;
    } catch (e) { throw e }
}

export const getProductsPaginatedNoStore = async (page: number, url?: string) => {
    try {
        const res = await axios.get(`https://api.amanditapratas.com.br/api/v1/products?page=${page}&size=${PAGE_SIZE}`);
        return res.data;
    } catch (e) { throw e }
}
...
export const getCategoriesNoStore = async () => {
    try {
        const res = await axios.get(`https://api.amanditapratas.com.br/api/v1/store/categories/no-store`);
        return res.data;
    } catch (e) { throw e }
}
...
export const getProductsByName = async (query: string, page: number) => {
    try {
      const res = await axios.get(`${getUrl()}/by-name?query=${query}&page=${page}&size=${PAGE_SIZE}`);
      return res.data;
    } catch (e) { throw e }
}

export const getProductsByCategory = async (category: string, page: number, url?: string) => {
    try {
...
export const getProductsByCategoryNoStore = async (category: string, page: number, url?: string) => {
    try {
        const endpoint = category === 'promo' 
...
export const getUrl = () => {
    ...
    if (typeof window !== "undefined") 
        return window.location.origin.replace(/^https?:\/\/(painel\.)?/, 'https://api.') + "/api/v1/products";
    return "http://localhost:8080/api/v1/products";
}